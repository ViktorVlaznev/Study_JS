...
let inputBirthday = document.querySelector('#inputBirthday');
let horoscopeDescription = document.querySelector('#horoscopeDescription');
let radioToday = document.querySelector('#radioToday');
let radioTomorrow = document.querySelector('#radioTomorrow');
let radioAfterTomorrow = document.querySelector('#radioAfterTomorrow');
let buttonEnter = document.querySelector('#buttonEnter');
// создадим массив с знаками гороскопа
let arrZodiacSign = ['Овен', 'Телец', 'Близнецы', 'Рак', 'Лев', 'Дева', 'Весы', 'Скорпион', 'Стрелец', 'Козерог', 'Водолей', 'Рыбы'];
// создадим массив из предсказаний
let arrPredictions = [
...
// создадим объект для хранения знаков зодиака с предсказаниями
let objarrZodiacSignPredictions = {
    'Овен': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Телец': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Близнецы': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Рак': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Лев': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Дева': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Весы': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Скорпион': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Стрелец': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Козерог': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Водолей': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
    'Рыбы': [arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)], arrPredictions[Math.floor(Math.random() * 432)]],
};
console.log(objarrZodiacSignPredictions);
// функция определения знака зодиака
function DeterminateZodiacSign(str) {
    let arr = str.split('-');
    str = arr[1] + '-' + arr[2];
    if (str != '-') {
        if (str >= '03-21' && str <= '04-19') {
            ...
            return 5;
        } else if (str >= '09-23' && str <= '10-23') {
            return 6;
        } else if (str >= '10-24' && str <= '11-22') {
            return 7;
        } else if (str >= '11-23' && str <= '12-21') {
            return 8;
        } else if ((str >= '12-22' && str <= '12-31') || (str <= '01-20' && str >= '01-01')) {
            return 9;
        } else if (str >= '01-21' && str <= '02-18') {
            return 10;
        } else if (str >= '02-19' && str <= '03-20') {
            return 11;
        } else return 'Введена некорректная дата.';
    }
}
// событие при нажатии на клавишу Enter
inputBirthday.addEventListener('keydown', function func(event) {
    if (event.key == 'Enter') {
        let zodiacSign = arrZodiacSign[DeterminateZodiacSign(inputBirthday.value)];
        if (zodiacSign) {
            if (radioToday.checked) {
                horoscopeDescription.innerHTML = 'Для знака: "' + zodiacSign + '" предсказание на сегодня: ' + objarrZodiacSignPredictions[zodiacSign][0];
            } else if (radioTomorrow.checked) {
                horoscopeDescription.innerHTML = 'Для знака: "' + zodiacSign + '" предсказание на завтра: ' + objarrZodiacSignPredictions[zodiacSign][1];
            } else if (radioAfterTomorrow.checked) {
                horoscopeDescription.innerHTML = 'Для знака: "' + zodiacSign + '" предсказание на послезавтра: ' + objarrZodiacSignPredictions[zodiacSign][2];
            }
        }
    }
});
