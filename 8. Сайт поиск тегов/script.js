...
buttonEnter.addEventListener('click', () => {
    if (objTeg[inputEnter.value] == undefined) {
        blockDescription.innerHTML = 'Такого тега не существует.'
    } else blockDescription.innerHTML = objTeg[inputEnter.value];
});
